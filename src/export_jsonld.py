...
def to_jsonld(result: Dict[str, Any], tale_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    created_at = _as_z(meta.get("created_at") or meta.get("inferred_at") or meta.get("generated_at") or _utc_now_iso())
    ...
    for rank, c in enumerate(candidates[:k], start=1):
        ...
        # Map anchors from your canonical export structure
        for a in anchors:
        ...
        "@graph": [
            {
                ...
                # decision summary (aligns with UI meta; optional but useful)
            ...
            },
            {
                ...
                "prov:used": [{"@id": model_iri}, {"@id": input_iri}],
